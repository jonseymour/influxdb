...
// lifetime of the described object. The Recorder interface is only used by 'described objects'; observers
// of the statistics Registry only see instances of Statistics, an interface which does not
...
// Built is the type of object that results from a successful call to Builder.Build() or Builder.MustBuild()
//
// The main purpose of this interface is provide access to an Open() method which will both
// simultaneously obtain a reference to a Recorder and register that Recorder (and its related) Statistics
...
//
//    import "github.com/influxdb/influxdb/stats"
//
//    type FooBar struct {
