...
// Instances of this type behave like the monitor does in the live system except that the
// test decides when the publishing method runs and whether to do it asynchronously or synchronously
// to the test
//
// In particular, it registers a Registry observer.
