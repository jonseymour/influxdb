...
This section is reserved for errata. In cases where the document is incorrect or inconsistent, such errata will be noted here with the contents of tis section taking precedence over the body of the document where there are discrepancies. Future full revisions of this document will fold the errata text into the body of the document.

#Revisions

##14 February, 2016

* refined description of cache behaviour and robustness to reflect current designed based on snapshots. Most references to checkpoints and evictions have been removed. See discussion here -  https://goo.gl/L7AzVu
